...
fs.writeFile("movie.txt", "forest gump, inception, harry potter", function(err){       // if there is no movies.txt, it will creat one and "forest gump, inception, harry potter" will be printed in movies.txt
